...
public class Xjssc {
	...
	private String caiZhong = "cz_xjssc";
	
	private String caiZhongQuick = "cz_xjssc_quick";
	
	private String lotteryId = "6";
	
	public Double xjssc(BrowserEmulator be, Touzhu touZhu, String touZhuMapUrl) throws Exception {
